...
public class CategoriaServiceImpl implements CategoriaService {
	...
	public void aggiungiArticolo(Categoria categoriaInstance, Articolo articoloInstance) throws Exception {
		...
		try {
			...
			// così jpa capisce che se risulta presente quella categoria non deve essere inserito
			categoriaInstance = entityManager.merge(categoriaInstance);
			// attenzione che articoloInstance deve essere già presente (lo verifica dall'id)
